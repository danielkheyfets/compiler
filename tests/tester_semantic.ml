...
{input = ScmLambdaSimple (["x"; "y"],ScmSeq[ScmApplic (ScmVar "x", [ScmVar "y"]);
                ScmLambdaSimple ([],ScmLambdaSimple ([],ScmLambdaSimple ([],ScmSet (ScmVar "x",ScmApplic (ScmLambdaSimple (["z"], ScmSet (ScmVar "y", ScmVar "x")),
                 [ScmVar "y"])))))]); 
expected =ScmLambdaSimple' (["x"; "y"],
 ScmSeq'
  [ScmSet' (VarParam ("x", 0), ScmBox' (VarParam ("x", 0)));
   ScmSet' (VarParam ("y", 1), ScmBox' (VarParam ("y", 1)));
   ScmApplic' (ScmBoxGet' (VarParam ("x", 0)),
    [ScmBoxGet' (VarParam ("y", 1))]);
   ScmLambdaSimple' ([],
    ScmLambdaSimple' ([],
     ScmLambdaSimple' ([],
      ScmBoxSet' (VarBound ("x", 2, 0),
       ScmApplic'
        (ScmLambdaSimple' (["z"],
          ScmBoxSet' (VarBound ("y", 3, 1), ScmBoxGet' (VarBound ("x", 3, 0)))),
        [ScmBoxGet' (VarBound ("y", 2, 1))])))))]);name = "RON_Test_Converted 8"};
   ...
   ScmLambdaSimple' (["y"],
    ScmSeq'
     [ScmBoxSet' (VarBound ("x", 0, 0),
       ScmConst' (ScmNumber (ScmRational (81, 1))));
      ScmApplicTP' (ScmVar' (VarFree "+"),
       [ScmBoxGet' (VarBound ("x", 0, 0)); ScmVar' (VarParam ("y", 0))])]);
   ScmApplicTP' (ScmVar' (VarFree "+"),
    [ScmBoxGet' (VarParam ("x", 0)); ScmVar' (VarParam ("y", 1));
     ScmVar' (VarParam ("z", 2))])]);name = "RON_Test_Converted 10"};



{input = ScmLambdaSimple (["x"; "y"],  ScmSeq   [ScmLambdaSimple ([], ScmSet (ScmVar "x", ScmVar "y"));    ScmLambdaSimple ([], ScmSet (ScmVar "y", ScmVar "x"))]); 
expected = ScmLambdaSimple' (["x"; "y"],
 ScmSeq'
  [ScmLambdaSimple' ([],
    ScmSet' (VarBound ("x", 0, 0), ScmVar' (VarBound ("y", 0, 1))));
   ScmLambdaSimple' ([],
    ScmSet' (VarBound ("y", 0, 1), ScmVar' (VarBound ("x", 0, 0))))]);name = "RON_Test_Converted 14"};
 ...
 ScmSeq'
  [ScmApplic' (ScmLambdaSimple' ([], ScmVar' (VarFree "x")), []);
   ...
   ScmApplicTP' (ScmLambdaOpt' ([], "x", ScmVar' (VarParam ("x", 0))),
    [ScmConst' (ScmNumber (ScmRational (104, 1)))])]);name = "RON_Test_Converted 9"};


{input = ScmApplic (ScmVar "y",  [ScmLambdaSimple (["y"],    ScmSeq  
   [ScmSet (ScmVar "a", ScmLambdaSimple (["b"], ScmApplic (ScmVar "a", [ScmVar "b"])));    
     ScmSet (ScmVar "t",       ScmLambdaSimple (["x"],        ScmSeq         [ScmSet (ScmVar "y",   
             ScmLambdaSimple (["j"], ScmApplic (ScmVar "x", [ScmVar "j"; ScmVar "x"])));          ScmVar "h"])); 
                  ScmApplic (ScmVar "y", [ScmVar "a"])])]); 
expected = ScmApplic' (ScmVar' (VarFree "y"),
 [ScmLambdaSimple' (["y"],
   ScmSeq'
    [ScmSet' (VarParam ("y", 0), ScmBox' (VarParam ("y", 0)));
     ScmSet' (VarFree "a",
      ScmLambdaSimple' (["b"],
       ScmApplicTP' (ScmVar' (VarFree "a"), [ScmVar' (VarParam ("b", 0))])));
     ScmSet' (VarFree "t",
      ScmLambdaSimple' (["x"],
       ScmSeq'
        [ScmBoxSet' (VarBound ("y", 0, 0),
          ScmLambdaSimple' (["j"],
           ScmApplicTP' (ScmVar' (VarBound ("x", 0, 0)),
            [ScmVar' (VarParam ("j", 0)); ScmVar' (VarBound ("x", 0, 0))])));
         ScmVar' (VarFree "h")]));
     ScmApplicTP' (ScmBoxGet' (VarParam ("y", 0)), [ScmVar' (VarFree "a")])])]);name = "RON_Test_Converted 12"};
  ...
  [ScmSet' (VarParam ("x", 0), ScmBox' (VarParam ("x", 0)));
   ...
   ScmLambdaSimple' (["x"],
    ScmSeq'
     [ScmSet' (VarParam ("x", 0), ScmBox' (VarParam ("x", 0)));
      ScmBoxSet' (VarParam ("x", 0),
       ScmConst' (ScmNumber (ScmRational (25, 1))));
      ScmLambdaSimple' ([], ScmBoxGet' (VarBound ("x", 0, 0)))]);
   ScmLambdaSimple' ([],
...
expected = ScmLambdaSimple' (["x"],
 ScmSeq'
  [ScmSet' (VarParam ("x", 0), ScmBox' (VarParam ("x", 0)));
   ...
   ScmLambdaSimple' (["x"],
    ScmSeq'
     [ScmSet' (VarFree "y", ScmVar' (VarParam ("x", 0)));
      ScmLambdaSimple' ([], ScmVar' (VarBound ("x", 0, 0)))]);
   ScmLambdaSimple' ([],
    ScmBoxSet' (VarBound ("x", 0, 0), ScmBoxGet' (VarBound ("x", 0, 0))))]);name = "RON_Test_Converted 23"};
